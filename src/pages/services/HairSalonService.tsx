...
import { CalendarClock, PenLine, Loader2, Scissors } from 'lucide-react';
...
const HairSalonService: React.FC<HairSalonServiceProps> = ({ 
  ...
  console.log('HairSalon service data:', serviceData);
  console.log('Service ID:', serviceData.service_id);
  
  if (!serviceData || !serviceData.service_id) {
    console.error('No service data or service_id provided to HairSalonService');
    return (
      <div className="p-4">
